  ...
  <nav class="navbar fixed-top shadow-sm bg-white">
    <div class="container-fluid">
      <a class="navbar-brand" href="">
        <img src="{{ asset('images/web-photos/aung-myin.png') }}" alt="Logo" width="20" class="d-inline-block align-text-top">
        Aung Myin Docs
      </a>
    </div>
  </nav>
  ...
  <div class="container-fluid d-flex">
    ...
    <div class="side-menu shadow">
      <ul class="nav flex-column py-5">
        ...
        <div class="collapse-nav mt-2">
          <p>
            <a data-bs-toggle="collapse" href="#collapse1" aria-expanded="false" aria-controls="collapse1">
              <i class="fa-solid fa-location-dot"></i> Interface & Navigation
            </a>
          </p>
          <div class="collapse" id="collapse1">
            <div class="card card-body">
              <li class="nav-item">
                <a class="nav-link" data-bs-toggle="tab" href="#home-panel"><i class="fa-solid fa-house-chimney"></i> Home Panel</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" data-bs-toggle="tab" href="#users-panel"><i class="fa-solid fa-user"></i> Users Panel</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" data-bs-toggle="tab" href="#patients-panel"><i class="fa-solid fa-clipboard-user"></i> Patients
                  Panel</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" data-bs-toggle="tab" href="#dictionary-panel"><i class="fa-solid fa-book"></i> Dictionary Panel</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" data-bs-toggle="tab" href="#pharmacy-panel"><i class="fa-solid fa-pills"></i> Pharmacy Panel</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" data-bs-toggle="tab" href="#pos-panel"><i class="fa-solid fa-tv"></i> POS Panel</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" data-bs-toggle="tab" href="#procedure-panel"><i class="fa-solid fa-bed-pulse"></i> Procedure Panel</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" data-bs-toggle="tab" href="#setting-panel"><i class="fa-solid fa-gear"></i> Setting Panel</a>
              </li>
            </div>
          </div>
        </div>
        ...
        <div class="collapse-nav mt-2">
          <p>
            <a data-bs-toggle="collapse" href="#collapse2" aria-expanded="false" aria-controls="collapse2">
          ...
          <div class="collapse" id="collapse2">
            <div class="card card-body">
              <li class="nav-item">
                <a class="nav-link" data-bs-toggle="tab" href="#admin"><i class="fa-solid fa-user-shield"></i> Admin Role</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" data-bs-toggle="tab" href="#receptionist"><i class="fa-solid fa-bell-concierge"></i> Receptionist
                  Role</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" data-bs-toggle="tab" href="#doctor"><i class="fa-solid fa-user-doctor"></i> Doctor Role</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" data-bs-toggle="tab" href="#pharmacist"><i class="fa-solid fa-user-tie"></i> Pharmacist Role</a>
              </li>
            </div>
          </div>
        </div>
    ...
    <div class="content">
      <div class="tab-content p-5">
        ...
        <div class="tab-pane fade show active" id="introduction">
          ...
          <p>
            Welcome to the user guide for Aung Myin, a comprehensive clinical
            management system designed to streamline patient management,
            facilitate medical procedures, and enhance the overall efficiency
            of healthcare facilities. This document provides detailed
            instructions on how to use the various features and
            functionalities of Aung Myin.
          </p>
          <h5>1.1 Overview of Aung Myin and its Purpose</h5>
          <p>
            Aung Myin is a web-based application that offers a wide range of
            tools and functionalities to support the management of healthcare
            clinics. It enables healthcare professionals to efficiently handle
            patient records, appointments, treatments, prescriptions, and
            more. Aung Myin aims to improve the overall quality of patient
            care by providing a centralized platform for managing clinical
          ...
          <p>
            Before using Aung Myin, please ensure the following prerequisites
            are met:
          </p>
          <ul>
            <li>
        ...
        <div class="tab-pane fade" id="getting-started">
          ...
          <p>
            ...
            application. It provides a brief overview of the system's features
            and benefits. From the landing page, you can navigate to the login
            or account creation page.
          </p>
          ...
          <ul>
            ...
            <li>
              Fill in the required information, such as your first name, last
          ...
          <p>
            The Package Selection feature allows you to choose the appropriate
            package for your clinic's needs and complete the purchase. Here's
          ...
          <ul>
            <li>
              ...
              and select the one that aligns with your clinic's requirements.
            </li>
            <li>
          ...
          <p>
            Once you finished creating your clinic, you will be presented with
            the user interface. Familiarize yourself with the various
            sections, menus, and navigation options available. The user
            interface typically consists of a top navigation bar, a side menu,
            and a main content area. Use the navigation elements from the side
            menu to access different panels and functionalities of the
            application.
          </p>
        </div>
        ...
        <div class="tab-pane fade" id="home-panel">
          ...
          <p>
            In the Home panel, you can search for patients using their names,
            ages, or father names. Follow these steps to search for patients:
          </p>
          <ul>
            <li>
        ...
        <div class="tab-pane fade" id="users-panel">
          ...
          <ul>
            ...
            <li>Click the "Submit" button to add the user to your clinic.</li>
          </ul>
          <h5>4.2 Managing User Roles and Permissions</h5>
          <p>
            As an administrator or authorized user, you can manage user roles
            and permissions in Aung Myin. Follow these steps to manage user
            roles:
          </p>
          <ul>
            <li>Navigate to the User panel.</li>
            <li>
              Locate the user whose role you want to manage and click the edit
              button.
            </li>
            <li>
              Select or deselect the appropriate roles or permissions for the
              user.
            </li>
          ...
          <ul>
            <li>Navigate to the User panel.</li>
            <li>
              Use the search bar to enter the name, role type, or phone number
              you want to find.
            </li>
        ...
        <div class="tab-pane fade" id="patients-panel">
          ...
          <p>
            The Patient Panel allows you to manage patient records and provide
            treatment to your patients. Follow the instructions below to
            perform tasks related to patient management:
          </p>
        ...
        <div class="tab-pane fade" id="dictionary-panel">
          ...
          <p>
            The Dictionary Panel allows you to manage a medical dictionary and
            quickly reference medical terms. Follow the instructions below to
            utilize the dictionary functionality:
          </p>
          ...
          <ul>
            ...
            <li>Enter the term and its definition in the provided fields.</li>
            <li>Save the term to add it to the dictionary.</li>
            <li>
              To manage existing terms, select the term and use the "Edit" or
              "Delete" buttons.
            </li>
          </ul>
          <h5>6.2 Searching for Medical Terms and Associated Information</h5>
          <ul>
            <li>Navigate to the Dictionary panel.</li>
            <li>
        ...
        <div class="tab-pane fade" id="pharmacy-panel">
          ...
          <p>
            ...
            available in your clinic. Follow the instructions below to perform
          ...
          <ul>
            <li>Navigate to the Pharmacy Panel.</li>
            <li>
              Use the search bar to enter the medicine name you want to find.
            </li>
        ...
        <div class="tab-pane fade" id="pos-panel">
          ...
          <p>
            ...
            managing the Point of Sale process. Follow the instructions below
            to utilize the features of the POS Panel:
          </p>
          ...
          <ul>
            ...
            <li>Locate the patient for whom you want to print an invoice.</li>
        ...
        <div class="tab-pane fade" id="procedure-panel">
          ...
          <ul>
            ...
            <li>
              To manage existing procedures, select the procedure and use the
              "Edit" or "Delete" buttons.
            </li>
          </ul>
        </div>
        ...
        <div class="tab-pane fade" id="admin">
          ...
          <ul>
            <li>
              Adding, Removing, and Editing Clinic Staff: Manage the clinic's
              staff members, including doctors, receptionists, pharmacists,
              and staff.
            </li>
            <li>
              Managing Patients: Add, edit, and remove patient records within
              the clinic.
            </li>
        ...
        <div class="tab-pane fade" id="receptionist">
          ...
          <p>
            The Receptionist Role feature provides receptionists with specific
          ...
          <ul>
            ...
            <li>
              Assigning Patients to Doctors: Assign patients to doctors based
              on priority.
            </li>
          </ul>
        </div>
        ...
        <div class="tab-pane fade" id="pharmacist">
          ...
          <p>
            Logging in as a Pharmacist: Access the system using your assigned
          ...
          <ul>
            ...
            <li>
              Selling Prescribed Medication through the POS Panel: Process
              sales of prescribed medications to patients using the POS panel.
            </li>
            <li>
