                                            ...
                                            <div class="row">
                                                ...
                                                {{-- <div class="col-md-6">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        {{-- <input type="text" class="form-control @error('name') is-invalid @enderror" id="type" name="name" required placeholder="Eg: ..." value="{{old('name')}}" autocomplete="off">
                                                        @error('name')
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control @error('code') is-invalid @enderror" id="code" name="code" value="{{$investigation->code}}" required placeholder="Eg: ..." value="{{old('code')}}" autocomplete="off">
                                                        @error('code')
                                                            <span class="invalid-feedback" role="alert" id="alert-message">
                                                                <strong>{{ $message }}</strong>
                                                            </span>
