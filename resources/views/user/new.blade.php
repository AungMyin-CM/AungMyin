                                ...
                                <div class="col-md-6">
                                    <div class="card card-primary">
                                        ...
                                        <div class="card-body">
                                            <div class="form-group">
                                                <div class="">
                                                    <input id="p_view" id="p_permissions" type="checkbox" name="p_view"
                                                ...
                                                <div class="form-check" style="padding:6px !important;">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col md-4 icheck-primary d-inline mt-2">
                                                            <input type="checkbox" id="p_create" name="p_permission[]"
                                                                value="p_create">
                                                            <label for="p_create">Create</label>
                                                        </div>
                                                        <div class="col md-4 icheck-primary d-inline mt-2">
                                                            <input type="checkbox" id="p_update" name="p_permission[]">
                                                            <label for="p_update">Update</label>
                                                        </div>
                                                        <div class="col md-4 icheck-primary d-inline mt-2">
                                                            <input id="p_delete" type="checkbox" name="p_permission[]">
                                                            <label for="p_delete">Delete</label>
                                                        </div>
                                                        <div class="col md-4 icheck-primary d-inline mt-2">
                                                            <input id="p_treatment" type="checkbox" name="p_permission[]">
                                            ...
                                            <div class="form-group">
                                                <div class="">
                                                    <input id="d_view" id="d_permissions" type="checkbox" name="d_view">
                                                ...
                                                <div class="form-check" style="padding:6px !important;">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col md-4 icheck-primary d-inline mt-2">
                                                            <input type="checkbox" id="d_create" name="d_create">
                                                            <label for="d_create">Create</label>
                                                        </div>
                                                        <div class="col md-4 icheck-primary d-inline mt-2">
                                                            <input type="checkbox" id="d_update" name="d_update">
                                                            <label for="d_update">Update</label>
                                                        </div>
                                                        <div class="col md-4 icheck-primary d-inline mt-2">
                                                            <input id="isFollowup" type="checkbox" name="isFollowup">
                                                            <label for="isFollowup">Delete</label>
                                                        </div>
