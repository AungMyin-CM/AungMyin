...
<body class="p-3 p-md-0">
    <div class="form-container shadow rounded">
        <form action="" class="form">
            <div class="container-fluid p-0 rounded-top" style="background-color: #003049;">
                            ...
                            <div class="row p-2">
                                <div class="col-md-6">
                                    <div class="form-floating mb-2">
                                        <input class="form-control" type="text" name="first_name" id="f_name" placeholder="First Name" tabindex="-1">
                                        <label for="f_name">First Name</label>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-floating mb-2">
                                        <input class="form-control" type="text" name="last_name" id="l_name" placeholder="Last Name" tabindex="-1">
                            ...
                            <div class="row p-2">
                                <div class="col-md-12">
                                    <div class="form-floating mb-3">
                                        <input class="form-control" type="password" name="password" id="password" placeholder="Password" tabindex="-1">
            ...
            success: function(result) {
                ...
                if (result == 'valid') {
                    ...
                    var button = $('<input/>').attr({
                        ...
                        style: 'background-color:#003049 !important;'
                    });
